...
export default {
  ...
  computed: {
    isButtonDisabled() {
      return String(this.temperature).trim() === '' || 
             this.fromUnit === 'select' || 
             this.toUnit === 'select'
    }
  },
  methods: {
    handleConvert() {
      const temperatureValue = parseFloat(this.temperature)
      
      if (isNaN(temperatureValue)) {
        this.output = 'Please enter a valid temperature'
        return
      }
